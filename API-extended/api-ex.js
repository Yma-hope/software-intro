...
//    .then(response => {
//        if (!response.ok) {
//            if (response.statue === 404) { //404 to show response not found
//                throw new Error("Data not found!");
//            }else if (response.status === 500) { //500 - issue on server
...
//template literals for parameters
//not operator - !
//response === 200 - it's okay
//!response.okay 
